...
export default class Login extends React.Component {
  ...
  private forgotPassword = (): void => {
    console.log('Change view forgotPassword');
  };
  ...
  render(): React.ReactNode {
    ...
    return (
      <ViewWrapper topBackgroundColor="#000000" statusBarStyle="light-content">
        ...
        {!!openCreate && <DocumentViewer title="Sign up" sourceNode={<SignUp close={() => this.setState({ openCreate: false })} />} onDismiss={() => this.setState({ openCreate: false })} dismissText="Cancel" disableContainerPadding={true} />}
      </ViewWrapper>
    );
  }
}